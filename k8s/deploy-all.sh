...
# Step 4: Initialize Vault with secrets
echo "🔑 Initializing Vault with database credentials..."
wait_for_job "vault-init" "student-api"

# Step 5: Install External Secrets Operator (if not already installed)
...
# Step 6: Deploy External Secrets configuration
